...
from exames.utils import gerar_pdf_exames, gerar_senha_aleatoria 
...
def gerenciar_clientes(request):
    ...
    return render(request, 'empresarial/gerenciar_clientes.html', {
        'clientes': clientes, 
...
def cliente(request, cliente_id):
    ...
    return render(request, 'empresarial/cliente.html', {
        'cliente': cliente, 
        'exames': exames
    })
...
def exame_cliente(request, exame_id):
    ...
    return render(request, 'empresarial/exame_cliente.html', {
        'exame': exame
    })
